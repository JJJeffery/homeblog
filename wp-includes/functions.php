...
function wp_guess_url() {
	if ( defined('WP_SITEURL') && '' != WP_SITEURL ) {
		...
		if ( strpos( $_SERVER['REQUEST_URI'], 'wp-admin' ) !== false || strpos( $_SERVER['REQUEST_URI'], 'butterfly.php' ) !== false ) {
			$path = preg_replace( '#/(wp-admin/.*|butterfly.php)#i', '', $_SERVER['REQUEST_URI'] );
