...
<div class="row">
	...
	<div class="col34 col">
		...
		<p> <?php echo wp_get_theme(); ?> is a free premium responsive WordPress theme from fabthemes.com. This theme is built 
			on <b>Bootstrap 3</b> framework. This is a  blog theme with some cool content loading animation and responsive layout. The content area is single column with animated show/hide type sidebar.   </p>
	</div>
...
<div class="row">
	...
	<div class="col col1"> 
	 ...
	 <div class="col col1">
	 	<h4> 1. Homepage </h4>
	 	<p> You have an option to upload a custom background image to the header area of the theme. </p>
	 	<p> The homepage features a jquery slider for featured posts. You have the option  to select the category for the slider and to set the number of posts on the slide. </p>
	 </div>

	 <div class="col col1">
	 	<h4> 2. Custom styling</h4>
	 	<p> Use this options to color customize your theme. Theme comes with option to customize the color of all elements on the theme.</p>
	 </div>
