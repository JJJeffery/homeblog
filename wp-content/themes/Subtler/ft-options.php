...
function FT_OP_options()
{
	...
	$options[] = array( "name" => "Body background color",
						"desc" => "Theme body background color",
						"id" => "fabthemes_body_color",
						"std" => "",
						"type" => "color");
	...
	$options[] = array( "name" => "Body text color",
						"desc" => "Theme body text color",
						"id" => "fabthemes_body_text",
						"std" => "",
						"type" => "color");

	$options[] = array( "name" => "Title color",
						"desc" => "Theme body text color",
						"id" => "fabthemes_title_text",
						"std" => "",
						"type" => "color");

	$options[] = array( "name" => "Light text color",
						"desc" => "Lighter shade of body text color",
						"id" => "fabthemes_light_text",
						"std" => "",
						"type" => "color");

	$options[] = array( "name" => "Border color",
						"desc" => "border color",
						"id" => "fabthemes_border_color",
						"std" => "",
						"type" => "color");
