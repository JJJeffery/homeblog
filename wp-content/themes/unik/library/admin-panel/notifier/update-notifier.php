...
define( 'NOTIFIER_THEME_NAME', 'Tempcore' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'tempcore' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.weblusive-themes.com/tempcore/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
