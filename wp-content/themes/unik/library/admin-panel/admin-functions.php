...
?>
	...
	switch ( $value['type'] ) {
		...
		case 'textarea':
		?>
			<textarea style="direction:ltr; text-align:left" name="weblusive_options[<?php echo $value['id']; ?>]" id="<?php echo $value['id']; ?>" type="textarea" cols="100%" rows="3" tabindex="4"><?php echo weblusive_get_option( $value['id'] );  ?></textarea>
		<?php
		break;

		case 'upload':
		?>
				<input id="<?php echo $value['id']; ?>" class="img-path" type="text" size="56" style="direction:ltr; text-laign:left" name="weblusive_options[<?php echo $value['id']; ?>]" value="<?php echo weblusive_get_option($value['id']); ?>" />
		...
		?>
				...
				<div style="clear:both; padding:10px 14px; margin:0 -15px;">
					...
					<select name="weblusive_options[<?php echo $value['id']; ?>][font]" id="<?php echo $value['id']; ?>[font]" style="width:150px;">				
