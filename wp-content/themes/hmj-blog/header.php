...
<head>
	...
	<script>
		...
		(function() {
			...
			hm.src = "//hm.baidu.com/hm.js?76c23c44e719009b49430a483bd94f47";
...
<div style="margin:0 auto;display: none;">
	<img src="<?php echo get_first_image(); ?>" width="100px" height="100px"/>
</div>
...
<!--			<a href="--><?php //echo esc_url( home_url( '/' ) ); ?><!--"><img src="--><?php //bloginfo('template_directory'); ?><!--/images/new-logo.png"></a>-->
<!--		</div>-->
		...
		<div class="header-time">
			...
			<div class="ht-search">
				<form name="formsearch" id="top-search" method="get" action="<?php bloginfo('home'); ?>">
					<!--				<div class="form clearfix">-->
					<label for="s" ></label>
					<input type="text" name="s" class="ht-keyword" onfocus="if (this.value == '输入关键词...') {this.value = '';}" onblur="if (this.value == '') {this.value = '输入关键词...';}" value="输入关键词..." />
					<input type="submit" class="ht-button" value="搜索"/>
					<!--				</div>-->
				</form>
			</div>
